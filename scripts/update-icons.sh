...
EMOJI_UNICODES="2300-23ff,24c2,25a0-27bf,2b1b,2b1c,2b50,2b55,3297,3299,1f004,1f0cf,1f100-1f64f,1f680-1f6ff,1f7e0-1f7eb,1f900-1f9ff,1fa70,1fa95"
EMOJI_UNICODES="0100-fffff"

echo "Trimming emoji font (Noto Color Emoji)..." >/dev/stderr
fonttools subset \
    "$FONT_FOLDER_TEMP/NotoColorEmoji.ttf" \
    --unicodes="$EMOJI_UNICODES" \
    --output-file="$FONT_FOLDER/NotoColorEmoji.trimmed.ttf"

echo "Trimming emoji font (Twemoji COLRv0)..." >/dev/stderr
fonttools subset \
    "$FONT_FOLDER_TEMP/TwemojiCOLRv0.ttf" \
    --unicodes="$EMOJI_UNICODES" \
    --output-file="$FONT_FOLDER/TwemojiCOLRv0.trimmed.ttf"
